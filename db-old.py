...
class Row:
  ...
  def __init__(self, id: int, values: List[int | str]) -> None:
      self.id = id
      self.values = values
...
class Column:
  """
  Base class for all columns in the database which are saved as JSON strings.
  ...
  def get(self, user_id: int, row_id: int = None, key: int = 0) -> int | str:
      """
...
def fetch(table: str, value: str = None, user_id: int = None) -> Union[int, str]:
  """
  ...
  Returns:
      Union[int, str]: The fetched data.
  """
